...
Deno.serve(
  handler(async (req: Request): Promise<Response> => {
    ...
    const isDevMock = (Deno.env.get('APP_ENV') === 'development') || !keySecret ||
      body.razorpaySignature === 'mock_signature_bypass';

    const sigOk = isDevMock ? true : await verifyPaymentSignature(
